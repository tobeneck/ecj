...
public class TraceableDouble{

    public TraceableDouble(){
        _value = 0;
        _traceVector = new ArrayList<TraceTuple>();
    }

    public TraceableDouble(double value, int initialTraceID){
        _value = value;
        _traceVector = new ArrayList<TraceTuple>();
        _traceVector.add(new TraceTuple(initialTraceID, 1.0));
    }

    public TraceableDouble(double value, List<TraceTuple> traceIDs){
        _value = value;
        _traceVector = new ArrayList<TraceTuple>();
    ...
    public void setValue(double value, List<TraceTuple> traceVector){ this._value = value; this._traceVector = traceVector; }
    ...
    public void fromString(String data){
        ...
        _value = Double.parseDouble(parsedData[0]);
        _traceVector = new ArrayList<TraceTuple>();
