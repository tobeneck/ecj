...
import ec.app.TracableVectorProblems.TracableVectorStatistics.ListOperations.DoubleListOperations;
...
import static ec.app.TracableVectorProblems.TracableVectorStatistics.ListOperations.IndividualAndGenomeListOperations.getGenomeLength;
import static ec.app.TracableVectorProblems.TracableVectorStatistics.ListOperations.IndividualAndGenomeListOperations.getGenotypeString;

public class TraceableVectorStatistics_old extends Statistics
{
    ...
    public void postEvaluationStatistics(final EvolutionState state)
    {
        ...
        for(int i = -1; i >= state.getMutationCounter(); i--) {
            double[] impact = IndividualAndGenomeListOperations.calculateImpact(i, inds, genomes);
            countingImpact.add(impact[0]);
            fitnessImpact.add(impact[1]);
            entropyImpact.add(impact[2]);
